...
describe("D4 diagnostics", () => {
  it("excludes only the exception period from missing supervision", () => {
    const result = missingSupervisionSlots({ date: "2026-09-20", periods: [{ id: "p1", academicYearId: "2026", gradeId: "g2", name: "1교시", order: 1, startTime: "18:00", endTime: "18:50", active: true, operatingDays: [0] }, { id: "p2", academicYearId: "2026", gradeId: "g2", name: "2교시", order: 2, startTime: "19:00", endTime: "19:50", active: true, operatingDays: [0] }], groups: [{ id: "g", academicYearId: "2026", gradeId: "g2", displayName: "G", type: "REGULAR", active: true, sortOrder: 1 }], edges: [{ id: "g_p1", academicYearId: "2026", gradeId: "g2", groupId: "g", periodId: "p1", active: true }, { id: "g_p2", academicYearId: "2026", gradeId: "g2", groupId: "g", periodId: "p2", active: true }], assignments: [], exceptions: [{ academicYearId: "2026", gradeId: "g2", scopeType: "grade", date: "2026-09-20", reasonType: "exam", reason: "x", active: true, periodIds: ["p1"] }] });
