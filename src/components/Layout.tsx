...
export function Layout() {
  ...
  const bootstrapView = scopeBootstrapView(loading, error, scope);
  const activeScope = scope ?? { academicYearId: "", gradeId: null };

  if (bootstrapView === "loading") return <div className="center-page">{"\uD559\uB144\uB3C4\uC640 \uD559\uB144 \uC815\uBCF4\uB97C \uD655\uC778\uD558\uB294 \uC911..."}</div>;
  return <div className="app-shell">
    ...
    <main className="content">
      {bootstrapView === "error" ? <div className="empty-state text-danger"><h2>{"\uBC94\uC704 \uC815\uBCF4\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4."}</h2><p>{"\uD559\uB144\uB3C4\uC640 \uD559\uB144 \uC815\uBCF4\uB97C \uBD88\uB7EC\uC624\uC9C0 \uBABB\uD588\uC2B5\uB2C8\uB2E4. \uC7A0\uC2DC \uD6C4 \uB2E4\uC2DC \uC2DC\uB3C4\uD574 \uC8FC\uC138\uC694."}</p></div> : bootstrapView === "missing" ? <div className="empty-state"><h2>{"\uD559\uB144\uB3C4 \uB610\uB294 \uD559\uB144 \uC815\uBCF4\uAC00 \uD544\uC694\uD569\uB2C8\uB2E4."}</h2></div> : <>
